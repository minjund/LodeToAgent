...
(() => {
  window.LoadToAgentMessages = Object.freeze({
    ...
    "session.reset_action": {"ko":"초기화하고 새 세션 시작","en":"Reset and start a new session","zh-CN":"重置并开始新会话"},
    "session.reset_help": {"ko":"이 버튼을 눌렀을 때만 대화를 새 세션으로 초기화합니다.","en":"The conversation resets to a new session only when you press this button.","zh-CN":"仅在按下此按钮时才会将对话重置为新会话。"},
