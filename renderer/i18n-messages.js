...
(() => {
  window.LoadToAgentMessages = Object.freeze({
    ...
    "quality.unit.records": {"ko":"기록","en":"records","zh-CN":"条记录"},
    ...
    "quality.shortcuts.search": {"ko":"기억 검색","en":"Search memory","zh-CN":"搜索记忆"},
    ...
    "agent.stop_response": {"ko":"응답 중단","en":"Stop response","zh-CN":"停止回复"},
    ...
    "agent.response_stopped": {"ko":"현재 AI 응답을 중단했습니다. 대화 세션은 계속 사용할 수 있습니다.","en":"Stopped the current AI response. The conversation session remains available.","zh-CN":"已停止当前 AI 回复，对话会话仍可继续使用。"},
    "agent.no_active_response": {"ko":"현재 중단할 수 있는 AI 응답이 없습니다.","en":"There is no active AI response to stop.","zh-CN":"当前没有可停止的 AI 回复。"},
    "agent.interrupt_failed": {"ko":"현재 AI 응답을 중단하지 못했습니다.","en":"Could not stop the current AI response.","zh-CN":"无法停止当前 AI 回复。"},
    ...
    "agent.chat_placeholder": {"ko":"메시지 입력…","en":"Message…","zh-CN":"输入消息…"},
    ...
    "drawer.message_unconfirmed": {"ko":"전달 확인 지연","en":"Delivery confirmation delayed","zh-CN":"送达确认延迟"},
    ...
    "drawer.message_interrupted": {"ko":"응답 중단됨","en":"Response stopped","zh-CN":"回复已停止"},
    ...
    "drawer.delivery_delayed_detail": {"ko":"터미널에는 전달했지만 AI 로그 반영이 늦습니다. 같은 메시지는 중복 전송하지 않고 계속 확인합니다.","en":"The prompt was handed to the terminal, but the AI log is updating slowly. The app keeps checking without sending the same message twice.","zh-CN":"提示已交给终端，但 AI 日志更新较慢。应用会继续检查，不会重复发送同一消息。"},
    ...
    "drawer.delivery_interrupted_title": {"ko":"현재 AI 응답을 중단했습니다","en":"The current AI response was stopped","zh-CN":"当前 AI 回复已停止"},
    "drawer.delivery_interrupted_detail": {"ko":"응답을 처리하던 터미널에 중단 신호를 보냈습니다. 같은 대화에서 새 메시지를 계속 보낼 수 있습니다.","en":"An interrupt signal was sent to the terminal handling the response. You can continue with a new message in the same conversation.","zh-CN":"已向处理回复的终端发送中断信号。您可以在同一对话中继续发送新消息。"},
    ...
    "drawer.delivery_evidence_delayed": {"ko":"확인 근거 · 60초 이상 대화 기록에서 메시지 미발견","en":"Evidence · message absent from the conversation log for over 60 seconds","zh-CN":"确认依据 · 超过 60 秒未在对话记录中发现消息"},
    ...
    "drawer.delivery_evidence_interrupted": {"ko":"확인 근거 · 응답 대상 터미널에 Ctrl+C 전달 완료","en":"Evidence · Ctrl+C delivered to the response terminal","zh-CN":"确认依据 · 已向回复终端发送 Ctrl+C"},
    ...
    "app.brand.subtitle": {"ko":"의도와 행위의 관제","en":"Intent and action control","zh-CN":"意图与行动控制"},
    "app.document.title": {"ko":"LoadToAgent · AI 작업 도우미","en":"LoadToAgent · AI Work Assistant","zh-CN":"LoadToAgent · AI 工作助手"},
    "app.nav.active": {"ko":"기억","en":"Memory","zh-CN":"记忆"},
    ...
    "settings.theme.eyebrow": {"ko":"화면 테마","en":"Display theme","zh-CN":"显示主题"},
    "settings.theme.title": {"ko":"화면 밝기","en":"Appearance","zh-CN":"外观"},
    "settings.theme.description": {"ko":"밝은 화면과 어두운 화면 중 편한 테마를 선택하세요. 다음 실행에도 그대로 유지됩니다.","en":"Choose the light or dark appearance that feels most comfortable. Your choice is kept for the next launch.","zh-CN":"请选择舒适的浅色或深色外观。下次启动时将保留您的选择。"},
    "settings.theme.light": {"ko":"라이트","en":"Light","zh-CN":"浅色"},
    "settings.theme.dark": {"ko":"다크","en":"Dark","zh-CN":"深色"},
    "settings.theme.switch_to_light": {"ko":"라이트 모드로 전환","en":"Switch to light mode","zh-CN":"切换到浅色模式"},
    "settings.theme.switch_to_dark": {"ko":"다크 모드로 전환","en":"Switch to dark mode","zh-CN":"切换到深色模式"},
    ...
    "terminal.agent.interrupt_target_missing": {"ko":"중단할 AI 터미널 연결을 찾지 못했습니다.","en":"Could not find the AI terminal connection to interrupt.","zh-CN":"找不到要中断的 AI 终端连接。"},
    "terminal.agent.interrupt_sent": {"ko":"{target}에 현재 응답 중단 신호를 보냈습니다.","en":"Sent the current-response interrupt signal to {target}.","zh-CN":"已向 {target} 发送当前回复中断信号。"},
    "terminal.agent.interrupt_failed": {"ko":"AI 터미널에 중단 신호를 보내지 못했습니다.","en":"Could not send the interrupt signal to the AI terminal.","zh-CN":"无法向 AI 终端发送中断信号。"},
    ...
    "terminal.composer.ai_hint": {"ko":"자연어로 지시하거나 / 를 입력해 빠른 명령을 찾아보세요.","en":"Write naturally, or type / to find a quick command.","zh-CN":"输入自然语言指令，或键入 / 查找快捷命令。"},
    ...
    "terminal.composer.expanded_announcement": {"ko":"긴 입력을 전체 편집 높이로 펼쳤습니다.","en":"Long input expanded to the full editing height.","zh-CN":"长输入已展开到完整编辑高度。"},
    "terminal.composer.long_summary": {"ko":"긴 입력 · {count}자 · {lines}줄","en":"Long input · {count} chars · {lines} lines","zh-CN":"长输入 · {count} 字符 · {lines} 行"},
    "terminal.composer.newline_hint": {"ko":"줄바꿈","en":"New line","zh-CN":"换行"},
    "terminal.composer.send_hint": {"ko":"전송","en":"Send","zh-CN":"发送"},
    "terminal.composer.shell_hint": {"ko":"명령과 여러 줄 내용을 읽기 좋은 형태로 입력하세요.","en":"Enter commands and multi-line content in a readable format.","zh-CN":"以易读的格式输入命令和多行内容。"},
    ...
    "terminal.slash.command.compact": {"ko":"긴 대화를 요약해 컨텍스트 공간 확보","en":"Summarize a long conversation to free context","zh-CN":"总结长对话以释放上下文空间"},
    "terminal.slash.command.context": {"ko":"현재 컨텍스트 사용량과 구성 확인","en":"Inspect current context usage and composition","zh-CN":"查看当前上下文用量和构成"},
    "terminal.slash.command.diff": {"ko":"현재 작업 트리의 변경사항 확인","en":"Inspect changes in the current working tree","zh-CN":"查看当前工作树中的更改"},
    ...
    "terminal.slash.command.model": {"ko":"현재 세션에서 사용할 모델 변경","en":"Change the model used by this session","zh-CN":"更改当前会话使用的模型"},
    "terminal.slash.command.new": {"ko":"현재 세션 안에서 새 대화 시작","en":"Start a new conversation in this session","zh-CN":"在当前会话中开始新对话"},
    "terminal.slash.command.review": {"ko":"커밋하지 않은 변경사항 코드 리뷰","en":"Review uncommitted working-tree changes","zh-CN":"审查工作树中未提交的更改"},
    "terminal.slash.command.status": {"ko":"모델, 컨텍스트, 사용 한도 상태 확인","en":"Check model, context, and usage-limit status","zh-CN":"查看模型、上下文和使用限额状态"},
    "terminal.slash.keyboard_help": {"ko":"↑↓ 이동 · Enter 선택 · Esc 닫기","en":"↑↓ move · Enter select · Esc close","zh-CN":"↑↓ 移动 · Enter 选择 · Esc 关闭"},
    ...
    "terminal.slash.open": {"ko":"빠른 명령 열기","en":"Open quick commands","zh-CN":"打开快捷命令"},
    "terminal.slash.open_short": {"ko":"명령","en":"Commands","zh-CN":"命令"},
    "terminal.slash.result_count": {"ko":"{count}개","en":"{count} results","zh-CN":"{count} 项"},
    "terminal.slash.selected": {"ko":"{command} 명령을 입력했습니다. Enter를 누르면 전송합니다.","en":"Inserted {command}. Press Enter to send it.","zh-CN":"已插入 {command}。按 Enter 发送。"},
    ...
    "ui.active_now": {"ko":"인과 기억","en":"Causal memory","zh-CN":"因果记忆"},
    "ui.active_tasks": {"ko":"기억","en":"Memory","zh-CN":"记忆"},
    ...
    "ui.ai_with_a_green_indicator_is_working_now": {"ko":"끝난 의도와 남은 증거를 인과 순서로 되짚어보세요.","en":"Retrace completed intentions and remaining evidence in causal order.","zh-CN":"按因果顺序回溯已完成的意图与尚存的证据。"},
    ...
    "ui.assign_a_new_task_to_ai": {"ko":"새 의도 시작하기","en":"Begin a new intent","zh-CN":"开始新的意图"},
    ...
    "ui.check_progress": {"ko":"기억에서 증거 찾기","en":"Find evidence in memory","zh-CN":"在记忆中寻找证据"},
    ...
    "ui.handle_items_that_need_your_review_first": {"ko":"확인 항목을 성격에 맞게 나눠 처리하세요.","en":"Handle each review item according to its category.","zh-CN":"请按类别处理各项待确认事项。"},
    ...
    "ui.items_marked_needs_review_need_a_response_or_choice": {"ko":"진행 차단, 선택 사항, 실행 위험을 구분해서 확인해요.","en":"Review blocking responses, optional follow-ups, and run risks separately.","zh-CN":"分别查看阻塞性回复、可选后续事项和运行风险。"},
    ...
    "ui.new_ai_task": {"ko":"새 의도","en":"New intent","zh-CN":"新意图"},
    ...
    "ui.only_tasks_waiting_for_your_response_or_choice_are_shown": {"ko":"최근 24시간 안에 활동한 세션의 진행 차단 응답, 선택적 후속 제안, 현재 실행 위험을 표시합니다.","en":"Shows blocking responses, optional follow-ups, and current run risks from sessions active in the last 24 hours.","zh-CN":"显示最近 24 小时活跃会话中的阻塞性回复、可选后续事项和当前运行风险。"},
    ...
    "ui.open_a_task_to_see_who_started_it_and_what": {"ko":"각 줄은 하나의 약속입니다. 의도에서 위임과 행위, 증거를 지나 필요한 판단으로 돌아오는 흐름을 보여줍니다.","en":"Each line is a promise, moving from intent through delegation, action, and evidence to the judgement it requires.","zh-CN":"每一行都是一个承诺：从意图出发，经过委派、行动和证据，最终回到所需的判断。"},
    ...
    "ui.recent_conversations_and_tasks": {"ko":"지금","en":"Now","zh-CN":"此刻"},
    ...
    "ui.see_what_is_being_handled_then_open_a_task_for": {"ko":"끝난 의도와 에이전트의 행위, 실제 명령, 돌아온 증거를 한 줄의 기억으로 확인합니다.","en":"Review completed intent, agent actions, actual commands, and returned evidence as one causal memory.","zh-CN":"将已完成的意图、智能体行动、实际命令和返回的证据作为一条因果记忆查看。"},
    "ui.see_which_ai_is_working_now": {"ko":"끝난 일이 다음 판단에 무엇을 남겼는지 봅니다.","en":"See what completed work left for the next decision.","zh-CN":"查看已完成的工作为下一次判断留下了什么。"},
    ...
    "ui.tasks_needing_review": {"ko":"판단","en":"Judgement","zh-CN":"判断"},
    ...
    "ui.view_active_work": {"ko":"기억 열기 →","en":"Open memory →","zh-CN":"打开记忆 →"},
    ...
    "ui.work_assigned_to_ai": {"ko":"살아 있는 의도","en":"Living intent","zh-CN":"活着的意图"},
    ...
    "memory.eyebrow": {"ko":"인과 기억 · 끝난 의도","en":"Causal memory · completed intent","zh-CN":"因果记忆 · 已完成的意图"},
    "memory.title_line1": {"ko":"끝난 일은 사라지지 않고,","en":"Completed work does not disappear.","zh-CN":"完成的工作不会消失，"},
    "memory.title_line2": {"ko":"다음 판단의 근거가 됩니다.","en":"It becomes evidence for the next decision.","zh-CN":"而会成为下一次判断的依据。"},
    "memory.description": {"ko":"기억은 과거 세션의 창고가 아닙니다. 어떤 의도가 어떤 행위를 낳았고 무엇이 증명되었는지 보존하여, 다음 선택을 더 나은 방향으로 바꿉니다.","en":"Memory is not a warehouse of old sessions. It preserves which intent caused which actions and what was proven, improving the next choice.","zh-CN":"记忆不是旧会话的仓库。它保留什么意图促成了什么行动以及证明了什么，从而改善下一次选择。"},
    "memory.metrics_label": {"ko":"기억 요약","en":"Memory summary","zh-CN":"记忆摘要"},
    "memory.records": {"ko":"인과 기억","en":"Causal memories","zh-CN":"因果记忆"},
    "memory.evidence": {"ko":"남은 증거","en":"Retained evidence","zh-CN":"保留的证据"},
    "memory.decisions": {"ko":"보존된 판단","en":"Retained judgements","zh-CN":"已保留的判断"},
    "memory.principle": {"ko":"완료는 사라지는 것이 아니라 조용해지는 것입니다.","en":"Completion does not disappear; it becomes quiet.","zh-CN":"完成不是消失，而是安静下来。"},
    "memory.archive_eyebrow": {"ko":"보존된 계보","en":"Preserved lineages","zh-CN":"保留的谱系"},
    "memory.archive_title": {"ko":"의도에서 판단까지","en":"From intent to judgement","zh-CN":"从意图到判断"},
    "memory.unit.records": {"ko":"기록","en":"records","zh-CN":"记录"},
    "memory.lineage": {"ko":"남겨진 인과","en":"Retained causality","zh-CN":"保留的因果"},
    "memory.intent": {"ko":"의도","en":"Intent","zh-CN":"意图"},
    "memory.agent": {"ko":"에이전트","en":"Agent","zh-CN":"智能体"},
    "memory.delegation": {"ko":"위임","en":"Delegation","zh-CN":"委派"},
    "memory.action": {"ko":"행위","en":"Action","zh-CN":"行动"},
    "memory.judgement": {"ko":"판단","en":"Judgement","zh-CN":"判断"},
    "memory.retained": {"ko":"보존","en":"Retained","zh-CN":"已保留"},
    "memory.direct": {"ko":"직접","en":"Direct","zh-CN":"直接"},
    "memory.count_short": {"ko":"{count}회","en":"{count}×","zh-CN":"{count} 次"},
    "memory.evidence_verified": {"ko":"검증됨","en":"Verified","zh-CN":"已验证"},
    "memory.evidence_unverified": {"ko":"미검증","en":"Unverified","zh-CN":"未验证"},
    "memory.evidence_missing": {"ko":"증거 없음","en":"No evidence","zh-CN":"无证据"},
    "memory.decision_retained": {"ko":"보존됨","en":"Retained","zh-CN":"已保留"},
    "memory.decision_pending": {"ko":"판단 대기","en":"Awaiting judgement","zh-CN":"等待判断"},
    "memory.decision_absent": {"ko":"기록 없음","en":"Not recorded","zh-CN":"未记录"},
    "memory.delegations": {"ko":"위임 {count}","en":"{count} delegates","zh-CN":"{count} 个委派"},
    "memory.executions": {"ko":"실행 {count}","en":"{count} executions","zh-CN":"{count} 次执行"},
    "memory.proof": {"ko":"증거","en":"Proof","zh-CN":"证据"},
    "memory.verified": {"ko":"검증됨","en":"Verified","zh-CN":"已验证"},
    "memory.recorded": {"ko":"기록됨","en":"Recorded","zh-CN":"已记录"},
    "memory.open_record": {"ko":"인과 기록 열기","en":"Open causal record","zh-CN":"打开因果记录"},
    "memory.empty_title": {"ko":"아직 보존된 기억이 없습니다","en":"No preserved memories yet","zh-CN":"还没有保留的记忆"},
    "memory.empty_description": {"ko":"완료된 의도가 생기면 행위와 증거가 여기에 함께 남습니다.","en":"When an intent is completed, its actions and evidence will remain here together.","zh-CN":"意图完成后，其行动和证据会一起保留在这里。"},
    "memory.wisdom_eyebrow": {"ko":"반복해 쓸 원칙","en":"Reusable principles","zh-CN":"可复用的原则"},
    "memory.wisdom_title_line1": {"ko":"이 제품이 지키는","en":"Three principles","zh-CN":"本产品恪守的"},
    "memory.wisdom_title_line2": {"ko":"세 가지 원칙","en":"this product keeps","zh-CN":"三项原则"},
    "memory.wisdom_description": {"ko":"기억에서 자동 추출한 결론이 아니라, 모든 에이전트가 지켜야 할 제품 원칙입니다.","en":"These are product principles every agent must follow, not conclusions automatically extracted from memory.","zh-CN":"这些不是从记忆中自动提取的结论，而是所有智能体都应遵守的产品原则。"},
    "memory.wisdom_visual_label": {"ko":"시각 검증","en":"Visual verification","zh-CN":"视觉验证"},
    "memory.wisdom_visual": {"ko":"첫 에이전트와 위험 신호가 보이면 작은 화면도 이해 가능하다.","en":"A small screen stays understandable when the first agent and risk signal remain visible.","zh-CN":"只要首个智能体和风险信号可见，小屏幕也能保持可理解。"},
    "memory.wisdom_visual_detail": {"ko":"전체를 축소하지 말고 첫 인과와 판단 지점을 우선합니다.","en":"Prioritize the first causal link and judgement point instead of shrinking everything.","zh-CN":"不要缩小一切，而要优先显示首个因果关系和判断点。"},
    "memory.wisdom_failure_label": {"ko":"실패 처리","en":"Failure handling","zh-CN":"失败处理"},
    "memory.wisdom_failure": {"ko":"실패는 증거가 없을 때만 조용해진다.","en":"Failure only becomes silent when its evidence is missing.","zh-CN":"只有缺少证据时，失败才会变得沉默。"},
    "memory.wisdom_failure_detail": {"ko":"실패한 명령·출력·다음 선택을 하나의 인과로 남깁니다.","en":"Retain the failed command, output, and next choice as one causal record.","zh-CN":"将失败的命令、输出和下一步选择保留为一条因果记录。"},
    "memory.wisdom_boundary_label": {"ko":"인간의 경계","en":"Human boundary","zh-CN":"人的边界"},
    "memory.wisdom_boundary": {"ko":"되돌리기 어려운 변화는 속도보다 이유를 요구한다.","en":"Hard-to-reverse change demands reasons more than speed.","zh-CN":"难以撤销的变更，比速度更需要理由。"},
    "memory.wisdom_boundary_detail": {"ko":"파괴적 실행 전에는 선택 이유도 함께 보존합니다.","en":"Before destructive execution, retain the reason for the choice as well.","zh-CN":"在破坏性执行前，也保留选择的理由。"},
    "management.advanced_tools": {"ko":"도구","en":"Tools","zh-CN":"工具"},
    ...
    "management.attention.optional": {"ko":"선택적 후속 제안","en":"Optional follow-up","zh-CN":"可选后续建议"},
    ...
    "management.filter_group_optional": {"ko":"선택 사항","en":"Optional","zh-CN":"可选事项"},
    ...
    "management.inbox_description": {"ko":"진행을 막는 필수 응답, 답하지 않아도 되는 선택 사항, 실행 위험을 서로 섞지 않고 보여줍니다.","en":"Separates blocking responses, optional follow-ups, and run risks instead of mixing them together.","zh-CN":"将阻塞性回复、可选后续事项和运行风险清晰分开显示。"},
    "management.inbox_empty": {"ko":"지금 처리할 일이 없습니다","en":"Nothing needs action now","zh-CN":"目前无需处理"},
    "management.inbox_empty_detail": {"ko":"최근 세션에 진행 차단 응답, 선택적 후속 제안, 실행 위험이 생기면 이곳에 나타납니다.","en":"Recent blocking responses, optional follow-ups, and run risks appear here.","zh-CN":"最近会话中的阻塞性回复、可选后续事项和运行风险会显示在这里。"},
    ...
    "management.category.guide": {"ko":"확인 항목 분류 기준","en":"Review-item classification","zh-CN":"待确认事项分类"},
    "management.category.required": {"ko":"진행 차단","en":"Blocking response","zh-CN":"阻塞性回复"},
    "management.category.required_detail": {"ko":"내 답이 있어야 다음 단계로 진행합니다.","en":"The task needs your answer before it can continue.","zh-CN":"任务需要您的回复才能继续。"},
    "management.category.optional": {"ko":"선택 사항","en":"Optional follow-up","zh-CN":"可选后续"},
    "management.category.optional_detail": {"ko":"답하지 않아도 기존 작업 결과는 완료 상태로 유지됩니다.","en":"No reply is needed to keep the existing result complete.","zh-CN":"无需回复，现有结果仍保持完成状态。"},
    "management.category.risk": {"ko":"실행 위험","en":"Run risk","zh-CN":"运行风险"},
    "management.category.risk_detail": {"ko":"답변 요청이 아니라 실패·정체·일시정지 상태를 점검해야 합니다.","en":"This is not a question; inspect a failure, stall, or pause.","zh-CN":"这不是提问；需要检查失败、停滞或暂停状态。"},
    ...
    "control.attention_count": {"ko":"확인 필요 {count}","en":"{count} need attention","zh-CN":"需确认 {count}"},
    "control.attention_more": {"ko":"나머지 {count}개 모두 보기","en":"View {count} more","zh-CN":"查看其余 {count} 项"},
    "control.attention_session_unit": {"ko":"메인 세션 확인 필요","en":"Lead session needs attention","zh-CN":"主会话需要确认"},
    "control.attention_subagent_summary": {"ko":"서브에이전트 {count}개의 확인 신호가 있습니다. 세부 내용은 메인 세션에서 확인하세요.","en":"{count} helper agents have attention signals. Review them from the lead session.","zh-CN":"{count} 个协助智能体发出确认信号，请从主会话查看。"},
    "control.attention_title": {"ko":"지금 개입할 작업 {count}","en":"{count} tasks need action","zh-CN":"{count} 个任务需要处理"},
    "control.home_eyebrow": {"ko":"살아 있는 의도 · 지금","en":"Living intent · now","zh-CN":"活着的意图 · 此刻"},
    "control.home_title_attention": {"ko":"무엇이 실행되는가보다, 왜 움직이는가를 먼저 봅니다.","en":"See why work is moving before what is running.","zh-CN":"先看工作为何推进，再看正在执行什么。"},
    "control.home_title_clear": {"ko":"무엇이 실행되는가보다, 왜 움직이는가를 먼저 봅니다.","en":"See why work is moving before what is running.","zh-CN":"先看工作为何推进，再看正在执行什么。"},
    "control.home_subtitle": {"ko":"각 줄은 하나의 약속입니다. 인간의 의도에서 출발해 위임과 실제 행위, 검증 가능한 증거를 지나 필요한 판단으로 돌아옵니다.","en":"Each line is a promise: from human intent through delegation, real action, and verifiable evidence to the judgement it requires.","zh-CN":"每一行都是一个承诺：从人的意图出发，经过委派、实际行动和可验证的证据，最终回到所需的判断。"},
    ...
    "control.completed_work_column": {"ko":"04–05 · 증거와 판단","en":"04–05 · Evidence and judgement","zh-CN":"04–05 · 证据与判断"},
    ...
    "control.command_work_kind": {"ko":"현실에 닿은 행위","en":"Action in the world","zh-CN":"作用于现实的行动"},
    ...
    "control.live_session": {"ko":"살아 있는 의도","en":"Living intent","zh-CN":"活着的意图"},
    ...
    "control.delivery_interrupted": {"ko":"AI 응답 중단됨","en":"AI response stopped","zh-CN":"AI 回复已停止"},
    ...
    "control.main_work_column": {"ko":"01 · 의도를 맡은 주체","en":"01 · Keeper of intent","zh-CN":"01 · 承接意图的主体"},
    "control.causal_spine_label": {"ko":"의도에서 판단까지의 인과 체크포인트","en":"Causal checkpoints from intent to judgement","zh-CN":"从意图到判断的因果检查点"},
    "control.causal_intent": {"ko":"의도","en":"Intent","zh-CN":"意图"},
    "control.causal_delegation": {"ko":"위임","en":"Delegation","zh-CN":"委派"},
    "control.causal_action": {"ko":"행위","en":"Action","zh-CN":"行动"},
    "control.causal_evidence": {"ko":"증거","en":"Evidence","zh-CN":"证据"},
    "control.causal_judgement": {"ko":"판단","en":"Judgement","zh-CN":"判断"},
    "control.causal_observed": {"ko":"관찰됨","en":"Observed","zh-CN":"已观察"},
    "control.causal_direct": {"ko":"직접 수행","en":"Direct","zh-CN":"直接执行"},
    "control.causal_count": {"ko":"{count}개","en":"{count}","zh-CN":"{count} 个"},
    "control.causal_in_motion": {"ko":"진행 중","en":"In motion","zh-CN":"进行中"},
    "control.causal_pending": {"ko":"아직 없음","en":"Pending","zh-CN":"尚无"},
    "control.causal_needs_judgement": {"ko":"판단 필요","en":"Needs judgement","zh-CN":"需要判断"},
    "control.causal_settled": {"ko":"판단 보존","en":"Judgement retained","zh-CN":"判断已保留"},
    ...
    "control.open_full_flow": {"ko":"인과 전체 보기","en":"Open full causality","zh-CN":"查看完整因果"},
    ...
    "control.subagent_work": {"ko":"위임된 역할","en":"Delegated role","zh-CN":"被委派的角色"},
    "control.running_work_column": {"ko":"02–03 · 위임과 실제 행위","en":"02–03 · Delegation and real action","zh-CN":"02–03 · 委派与实际行动"},
    ...
    "usage.title": {"ko":"남은 사용 한도","en":"Remaining usage limits","zh-CN":"剩余使用限额"},
    "usage.description": {"ko":"설정에서 표시한 AI의 실제 단기·주간 한도를 보여줍니다.","en":"Actual short-term and weekly limits for AIs enabled in Settings.","zh-CN":"显示设置中启用的 AI 的实际短期和每周限额。"},
    "usage.home_hint": {"ko":"필요할 때 펼쳐 보는 보조 정보","en":"Secondary information, available when needed","zh-CN":"需要时展开查看的辅助信息"},
    "usage.refresh": {"ko":"한도 새로고침","en":"Refresh limits","zh-CN":"刷新限额"},
    "usage.refreshing": {"ko":"확인 중…","en":"Checking…","zh-CN":"正在检查…"},
    "usage.remaining_percent": {"ko":"{percent}% 남음","en":"{percent}% left","zh-CN":"剩余 {percent}%"},
    "usage.resets_at": {"ko":"{time} 초기화","en":"Resets {time}","zh-CN":"{time} 重置"},
    "usage.reset_unknown": {"ko":"초기화 시각 미확인","en":"Reset time unavailable","zh-CN":"重置时间不可用"},
    "usage.short_limit": {"ko":"단기 한도","en":"Short-term limit","zh-CN":"短期限额"},
    "usage.weekly_limit": {"ko":"주간 한도","en":"Weekly limit","zh-CN":"每周限额"},
    "usage.model_limit": {"ko":"모델별 한도","en":"Model limit","zh-CN":"模型限额"},
    "usage.not_available": {"ko":"수치 미확인","en":"Unavailable","zh-CN":"数值不可用"},
    "usage.no_reset": {"ko":"제공사가 수치를 보내지 않았습니다.","en":"The provider did not return a value.","zh-CN":"提供商未返回数值。"},
    "usage.unavailable": {"ko":"한도 정보를 표시할 수 없음","en":"Limit information unavailable","zh-CN":"无法显示限额信息"},
    "usage.cli_unavailable": {"ko":"이 컴퓨터에서 CLI가 감지되지 않았습니다.","en":"The CLI was not detected on this computer.","zh-CN":"此电脑上未检测到 CLI。"},
    "usage.sign_in_required": {"ko":"CLI 로그인이 필요합니다.","en":"Sign in through the CLI first.","zh-CN":"请先通过 CLI 登录。"},
    "usage.run_once": {"ko":"Codex를 한 번 실행하면 최신 한도가 기록됩니다.","en":"Run Codex once to record its latest limits.","zh-CN":"运行一次 Codex 以记录最新限额。"},
    "usage.refresh_failed": {"ko":"제공사에서 한도를 가져오지 못했습니다. 다시 시도해 주세요.","en":"Could not retrieve limits from the provider. Try again.","zh-CN":"无法从提供商获取限额，请重试。"},
    "usage.provider_not_supported": {"ko":"이 제공사는 CLI에서 잔여 한도 수치를 제공하지 않습니다.","en":"This provider does not expose remaining limits through its CLI.","zh-CN":"此提供商未通过 CLI 提供剩余限额。"},
    ...
    "usage.accuracy_note": {"ko":"제공사가 공개한 실제 구간만 표시합니다. 일일 한도로 임의 환산하지 않습니다.","en":"Only provider-reported windows are shown; values are not converted into an artificial daily limit.","zh-CN":"仅显示提供商报告的实际区间，不会换算为虚构的每日限额。"},
    "session.live_context": {"ko":"현재 컨텍스트","en":"Current context","zh-CN":"当前上下文"},
    "session.reset": {"ko":"새 AI 세션","en":"New AI session","zh-CN":"新建 AI 会话"},
    "session.reset_eyebrow": {"ko":"현재 대화는 그대로 유지됩니다","en":"Your conversation history will stay intact","zh-CN":"当前对话记录将保持不变"},
    "session.reset_action": {"ko":"새 세션 시작","en":"Start new session","zh-CN":"开始新会话"},
    "session.reset_busy": {"ko":"새 세션 여는 중…","en":"Starting new session…","zh-CN":"正在开始新会话…"},
    "session.reset_help": {"ko":"새 컨텍스트가 필요할 때 이 버튼으로 새 AI 세션을 시작합니다.","en":"Use this button when you need a new AI session with fresh context.","zh-CN":"需要全新上下文时，可使用此按钮开始新的 AI 会话。"},
    "session.reset_confirm": {"ko":"기존 대화 기록은 유지하고 새 AI 세션을 시작할까요? 현재 컨텍스트는 새로 시작됩니다.","en":"Start a new AI session while keeping the existing conversation history? The active context will start over.","zh-CN":"是否在保留现有对话记录的同时启动新的 AI 会话？当前上下文将重新开始。"},
    "session.fresh_session_title": {"ko":"{provider} · 새 세션","en":"{provider} · New session","zh-CN":"{provider} · 新会话"},
    "session.reset_complete": {"ko":"기존 기록은 유지하고 새 세션을 열었습니다.","en":"A new session was opened; existing history was kept.","zh-CN":"已打开新会话，并保留现有历史。"},
    "session.reset_failed": {"ko":"새 세션을 열지 못했습니다.","en":"Could not open a new session.","zh-CN":"无法打开新会话。"},
    "agent.command_and_prompt_help": {"ko":"/model 모델명 · 등록 명령 /명령 · Enter 전송 · Shift+Enter 줄바꿈 · {help}","en":"/model model-name · Registered /command · Enter to send · Shift+Enter for a new line · {help}","zh-CN":"/model 模型名 · 已注册 /命令 · Enter 发送 · Shift+Enter 换行 · {help}"},
    "drawer.tab_summary_short": {"ko":"요약","en":"Summary","zh-CN":"摘要"},
    "drawer.tab_chat_short": {"ko":"대화","en":"Chat","zh-CN":"对话"},
    "drawer.tab_progress_short": {"ko":"과정","en":"Steps","zh-CN":"过程"},
    ...
    "agent.native_command_sent": {"ko":"현재 대화를 유지한 채 CLI 명령을 그대로 전달했습니다.","en":"Sent the CLI command while keeping the current conversation open.","zh-CN":"已在保持当前对话打开的同时发送 CLI 命令。"},
  });
})();
