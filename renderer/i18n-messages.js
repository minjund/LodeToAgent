...
(() => {
  window.LoadToAgentMessages = Object.freeze({
    ...
    "graph.runtime_count_explanation": {"ko":"일반 실행 AI {standard}개와 TMUX AI {tmux}개를 합산했습니다. 작업 중 도움 AI {helpers}개는 이 수에 포함됩니다.","en":"Includes {standard} standard AI and {tmux} TMUX AI. The {helpers} active helper AI are included in this count.","zh-CN":"合计 {standard} 个普通 AI 和 {tmux} 个 TMUX AI，其中包含 {helpers} 个工作中的协助 AI。"},
