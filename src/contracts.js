 ...
 * @property {{category:'required'|'optional'|'risk'|'none',required:boolean,actionable:boolean,kind:string,summary:string,requestedAt:string|null,source:string,confidence:string}} attention Mutually exclusive classification for a blocking response, optional follow-up, run risk, or no action.
